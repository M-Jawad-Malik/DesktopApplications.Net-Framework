...
function loadChatList() {
    ...
    if (firebase.auth().currentUser.photoURL != null) {
        ...
        var db = firebase.database().ref('/users/' + firebase.auth().currentUser.uid.toString())
            ...
            userdb.on('value', function (userlists) {
                userlists.forEach(function (userdata) {
                    ...
                    if (chatPartnerId == usr.uid) {
                        document.getElementById('lstChat').innerHTML += `<li class="list-group-item list-group-item-action"  onclick="startChat('${chatPartnerId}','${usr.username}','${usr.profileImageUrl}','${photourl}')">
                            <div class="row">
                                <div class="col-md-2">
